			...
			if(lastCode != joystickCode || gameSelected)
			{
				...
				switch(joystickCode){
					...
					case 0x01:
						...
						else if(gameSelected == 1 && !buttonPressed)
						{
							buttonPressed = 1;
							moveUp = 1;
							if(!play){
				...
				if(photoGallerySelected == 1)
				{
					...
					switch(currentPic)
					{
						...
						case 1:
							...
							break;
						case 2: 
							GLCD_Bitmap(25, pointerLocation, 32, 32, CharHead); 
							break;
					}
				}
				...
				else if(gameSelected == 1)
				{
					...
					if(justOpened == 1)
					{
						...
						//GLCD_Bitmap(0, 150, 320, 80, foreground);		
						//GLCD_Bitmap(0, 0, 300, 97, logo);  					
						GLCD_Bitmap(120, 120, 34, 24, bird_mid); 
					}		
